        ...
        <div class="portlet light bg-inverse">
            <div class="portlet-title">
                <div class="caption">
                    ...
                    <span class="caption-subject font-red-sunglo bold uppercase">app圈子</span>
                ...
                <div class="table-info-form ">
                    <form id="datatables_form" onsubmit="return false;">
                        <div class="col-md-8 input-group ">
                            <input type="text" name="searchText" class="input-xlarge" placeholder="请输入所属文章或用户昵称 或评论内容">
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        var tableInfo = {
            ...
            'tableDiv' :'#table_div',
            'tableObj' :'#table_list',
            'tableUrl' :'/circle/get-comment-list',
            'tableData':{},
            'tableOrder':[],
            'tableColumn':[
