                                ...
                                <div class="form-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-7 valdate">
                                            <div class="input-icon right">
                                                <i class="fa"></i>
                                                <input type="text" id="cname" name="cname" class="form-control" required maxlength=20 />
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-7 valdate">
                                            <div class="input-icon right">
                                                <i class="fa"></i>
                                                <input type="text" id="ename" name="ename" class="form-control" required maxlength=20 />
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-7 valdate">
                                            <div class="input-icon right">
                                                <i class="fa"></i>
                                                <input type="text" id="areaCode" name="areaCode" class="form-control" maxlength=20 />
                                            </div>
                                        </div>
                                    </div>
                                </div>
...
<script type="text/javascript">
    jQuery(document).ready(function() {
        FormValidation.init("addCountry");
    });
