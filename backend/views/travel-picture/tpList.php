            ...
            <div class="portlet-title">
                <div class="caption">
                    ...
                    <span class="caption-subject font-red-sunglo bold uppercase">旅图管理</span>
                            <span class="caption-helper">旅图列表
                            </span>
                </div>
                <div class="actions">
                ...
                <div class="table-info-form ">
                    <form id="datatables_form" onsubmit="return false;">
                        <div class="col-md-8 input-group ">
                            <input type="text" name="searchText" class="input-xlarge" placeholder="请输入国家、城市、标题或用户昵称">
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        var tableInfo = {
            ...
            'tableDiv' :'#table_div',
            'tableObj' :'#table_list',
            'tableUrl' :'/travel-picture/get-tp-list',
            'tableData':{},
            'tableOrder':[],
            'tableColumn':[
                {"targets": [0],"data": "id",
                ...
                },
                {
                    ...
                    "render": function(data, type, full) {
                        ...
                        html +='<a href="javascript:;" onclick="deleteT(\''+data+'\')" class="btn default btn-xs red-sunglo"><i class="fa fa-trash-o"></i> 删除</a>';
                        return html;
                    }
                }
            ],
    ...
    function answer(id)
    {
        Main.openModal("/travel-picture/sys-answer?id="+id);
    }
