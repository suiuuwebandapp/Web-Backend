...
class AlipaywapConfig{
    ...
    public function __construct(){
        ...
        $this->alipay_config['private_key_path']	= dirname(__FILE__) .'/../key/rsa_private_key.pem';

        //支付宝公钥（后缀是.pen）文件相对路径
        $this->alipay_config['ali_public_key_path']= dirname(__FILE__) .'/../key/alipay_public_key.pem';
        ...
        $this->alipay_config['cacert']    =dirname(__FILE__).'../cacert.pem';
