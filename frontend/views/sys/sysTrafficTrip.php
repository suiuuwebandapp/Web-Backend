                ...
                <div id="carServiceDiv">
                    ...
                    <div class="lines clearfix">
                        <div class="line_two_ipt_div">
                            ...
                            <div class="selets cty">
                                <input type="text" class="line_ipt" id="overTime" ipt-type="number_ipt" placeholder="选填"  value="<?=empty($travelInfo['trafficInfo']['overTimePrice'])?'':$travelInfo['trafficInfo']['overTimePrice'];?>">
                                <span>￥/小时</span>
                            </div>
                        </div>
                        <div class="line_two_ipt_div">
                            ...
                            <div class="selets cty">
                                <input type="text" class="line_ipt" id="overMileage" ipt-type="number_ipt" placeholder="选填"  value="<?=empty($travelInfo['trafficInfo']['overMileagePrice'])?'':$travelInfo['trafficInfo']['overMileagePrice'];?>">
                                <span>￥/公里</span>
                            </div>
                        </div>
                    </div>
