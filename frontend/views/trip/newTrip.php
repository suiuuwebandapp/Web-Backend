...
<div class="bjy clearfix" id="bjy-box">
    ...
    <div class="bjy-list clearfix">
        ...
        <div class="bjy-bj2 bjy-bj">
            ...
            <div id="scenicList" class="jings clearfix" style="display: none"></div>
            <div style="width: 100%;text-align: center">
                <iframe id="editMapFrame" name="editMapFrame" src="/google-map/edit-scenic-map" width="830px" height="300px;" frameborder="0" scrolling="no" style="display: none"></iframe>
                <img id="editMapImg" src="/assets/images/my_map.jpg" />
                <div class="jing">
