...
<div class="jtbjy clearfix" id="bjy-box">
    ...
    <div class="bjy-list clearfix">
        ...
        <div class="bjy-bj1 bjy-bj" style=" display:block;">
            ...
            <?=frontend\widgets\TripTitleImg::widget(); ?>
            <!--step1 提示-->
        ...
        <div class="bjy-bj2 bjy-bj">
            ...
            <div class="lines">
                <div class="selets cty">
                    <select name="" id="licenseYear" >
                        <?php for($i=0;$i<=30;$i++){$y=date("Y",time())-$i;?><option value='<?=$y?>'><?=$y.'年'?></option><?php } ?>
                    </select>
                </div>
                <div class="selets">
                    <select name="" id="licenseMonth">
                        <?php for($i=1;$i<=12;$i++){?><option value='<?=$i?>'><?=$i.'月'?></option><?php } ?>
                    </select>
                </div>
            </div>
            ...
            <div class="lines">
                <div class="selets cty">
                    <input type="text" ipt-type="number_ipt" class="line_ipt" id="maxUserCount">
            ...
            <div class="time">
                ...
                <input type="radio" name="scheduledRadio" value="2" id="no"><label for="no">需提前<input id="scheduledTime" ipt-type="number_ipt" type="text" placeholder="几天">预定</label>
            </div>
        ...
        <div class="bjy-bj3 bjy-bj">
            ...
            <input type="text" class="car" id="carType">
            <!--step3Pro-->
            ...
            <div class="lines clearfix">
                <div class="line_two_ipt_div">
                    ...
                    <div class="selets cty">
                        <input type="text" class="line_ipt" id="seatCount" ipt-type="number_ipt">
        ...
        <div class="bjy-bj4 bjy-bj">
            ...
            <div class="price1 clearfix">
                <div id="carServiceDiv">
                    ...
                    <p><input type="text" class="text01" id="carBasePrice" ipt-type="number_ipt"><b>RMB/每天</b></p>
                    <div class="lines clearfix">
                        <div class="line_two_ipt_div">
                            <span class="spn_title" style="width: auto">服务时长</span> <span class="form_tip" id="serviceTimeTip" style="width: 130px !important;"></span>
                            <div class="selets cty">
                                <input type="text" class="line_ipt" id="serviceTime" ipt-type="number_ipt">
                                <span>小时/每天</span>
                            </div>
                        </div>
                        <div class="line_two_ipt_div">
                            ...
                            <div class="selets cty">
                                <input type="text" class="line_ipt" id="serviceMileage" ipt-type="number_ipt">
                                <span>公里/每天</span>
                            </div>
                        </div>
                    </div>
                ...
                <div id="airplaneServiceDiv">
                    ...
                    <p><input type="text" class="text02" id="airBasePrice" ipt-type="number_ipt"><b>每次</b></p>
                    ...
                    <div class="serverPrice clearfix" style="display: none" id="nextPriceDiv">
                        <p>
                            <input type="text" class="timePicker" data-field="time" id="nightTimeBegin" placeholder="起始时间" />
                            <span>-</span>
                            <input type="text" class="timePicker" data-field="time" id="nightTimeEnd" placeholder="结束时间"/>
                            <span>加收夜间服务费</span>
                        </p>
                        <p><span>夜间加收服务费</span><input type="text" class="text" ipt-type="number_ipt" id="nightTimePrice"><b>￥/每次</b></p>
                    </div>
                </div>
            </div>
        ...
        <div class="bjy-bj5 bjy-bj clearfix"  id="bjy">
            <div class="box01">
                ...
                <textarea id="info" placeholder="告诉游客关于您车辆信息之外有哪些服务优势"></textarea>
            ...
            <div class="serverPrice clearfix" id="serviceTimeDiv" style="display: none">
                <p>
                    <input type="text" class="timePicker" data-field="time" id="serviceTimeBegin" placeholder="起始时间"/>
                    <span>-</span>
                    <input type="text" class="timePicker" data-field="time" id="serviceTimeEnd" placeholder="结束时间"/>
                    <span>可接受服务</span>
                </p>
            </div>
    ...
    var NewTrafficTrip = function(){
        ...
        return {
            ...
            addDetail: function (type) {
                var html = '<p><input type="text" value="" class="text2"><a href="javascript:;" onclick="NewTrafficTrip.removeDetail(this)" class="jian"></a></p>';
                if (type) {
