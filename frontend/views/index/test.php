...
<div data-role="content" id="dateDiv" style="display: block">
    <table cellpadding="0" cellspacing="0" id="1" width="100%">
        <tr>
            <td><style>
                    body,td,.p1,.p2,.i{font-family:arial}
                    table{border:0; margin:0 auto; background:#FFF}
                    #cal{border:1px solid #c3d9ff;font-size:12px; overflow:hidden}
                    #cal #top{height:40px;background:#e7eef8;color:#003784;text-align:center; overflow:hidden}
                    #cal #top select{font-size:12px}
                    #cal #top input{padding:0}
                    #cal ul#wk{margin:0;padding:0;height:25px; width:100%}
                    #cal ul#wk li{float:left; width:14%;text-align:center;line-height:25px;list-style:none}
                    #cal ul#wk li b{font-weight:normal;color:#c60b02}
                    #cal #cm{clear:left;border-top:1px solid #ddd;border-bottom:1px dotted #ddd;position:relative;text-align:center;}
                    #cal #cm .cell{position:absolute;width:10%;height:36px;text-align:center;margin:0 0 0 9px}
                    #cal #cm .cell .so{font:bold 16px arial; text-align:center;}
                ...
                <div id="cal" data-role="content">
                    <div id="top">
                        <div style="height:40px;" data-theme="b">
                            <a id="a_up" href="#"  style="float: left; display: block;width: 20%; line-height: 40px; height:40px; text-align: center; ">上一页</a>
                            <h1 id="dateH1" style="float: left; width: 60%;  height: 40px; line-height: 40px; font-size: 18px;">2014年7月</h1>
                            <a id="a_next" href="#" style="float: left; display: block;;width: 20%; line-height: 40px; height:40px; text-align: center; ">下一页</a>
                        </div>
                        <div  data-role="controlgroup" data-type="horizontal" style="display:none">
                            ...
                            <input type="button" value="今天" title="点击后跳转回今天" style="padding:0px">
    ...
    <script type="text/javascript">
        ...
        (function(){
            ...
            var W=(function(){
                var U1=M("top").getElementsByTagName("a")[0];
                var D1=M("top").getElementsByTagName("a")[1];
            ...
            var N=(function(){
                function C(){
                    ...
                    for(var a=0;a<c.length;a++){
                        ...
                        X.style.left=(a%7)*((document.documentElement.clientWidth-60)/7)+"px";
...
// http://www.dajiaz.com
                    ...
                    cell.click(function()
                    {
                        ...
                        var n =$('#selectN option:selected').text();
                        var y =$('#selectY option:selected').text();
                        var r =$(this).children().eq(0).text();
                        dateNow='';
                        dateNow=n+"-"+y+"-"+r;
                        if(dateInList(dateNow)){
                        dateList(this,dateNow,false);
                            $(this).css('background','none');
                        }else
                        {
                            $(this).css('background-color','#ccc');
                            dateList(this,dateNow,true);
                        }
    ...
    <script>
        ...
        function dateList(obj,dateNow,isAdd)
        {
            if(isAdd){
            arr.push(dateNow);
                arrObj.push(obj);
