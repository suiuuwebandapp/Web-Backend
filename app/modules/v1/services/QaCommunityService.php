...
class QaCommunityService  extends BaseDb {
    ...
    public function getQuestionTitle()
    {
        ...
        try{
            $this->qaCommunityDb=new QaCommunityDb($conn);
            $rst = $this->qaCommunityDb->getQuestionTitle();
            return $rst;
        }catch (Exception $e){
            throw $e;
        }finally{
    ...
    public function updateAnswerCount($id,$add)
    {
        ...
        try{
            ...
            $this->qaCommunityDb->updateAnswerNumber($id,$count);
            return $info;
        }catch (Exception $e){
            throw $e;
        }finally{
    ...
    public function getQaCountry()
    {
        try{
            $conn=$this->getConnection();
            $this->qaCommunityDb=new QaCommunityDb($conn);
            return $this->qaCommunityDb->getQuestionCountry();
        }catch (Exception $e){
            throw $e;
        }finally{
            $this->closeLink();
    ...
    public function getQaCity($id)
    {
        try{
            $conn=$this->getConnection();
            $this->qaCommunityDb=new QaCommunityDb($conn);
            return $this->qaCommunityDb->getQuestionCity($id);
        }catch (Exception $e){
            throw $e;
        }finally{
            $this->closeLink();
