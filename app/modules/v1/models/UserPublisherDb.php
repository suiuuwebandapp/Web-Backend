...
class UserPublisherDb extends ProxyDb
{
    ...
    {
        $sql = sprintf("
            SELECT userPublisherId,userId,countryId,cityId,lon,lat,idCard,idCardImg,kind,tripCount,leadCount,registerTime,lastUpdateTime,score FROM  user_publisher
            WHERE userPublisherId=:userPublisherId
